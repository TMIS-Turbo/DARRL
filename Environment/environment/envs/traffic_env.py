...
config_path = os.path.dirname(__file__)+"/../../../Data/Intersection_1.sumocfg"  # Unprotected left turn in mixed traffic
...
class Traffic_Env(gym.Env):
    ...
    def reset(self):
        ...
        # print("@@@random_seed_element", random_seed_element.getAttribute("value"))

        if self.reset_times % 1 == 0:
